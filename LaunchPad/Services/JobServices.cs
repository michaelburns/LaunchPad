...
namespace LaunchPad.Services
{
    ...
    public class JobServices : IJobServices
    {
        ...
        public JobServices()
        {
            ...
            options.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=LaunchPad;Trusted_Connection=True;MultipleActiveResultSets=true"); // This needs to come from configuration. 
